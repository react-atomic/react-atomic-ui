...
var HTMLToPDF = function HTMLToPDF(props, ref) {
  ...
  var pdf = Object(react__WEBPACK_IMPORTED_MODULE_1__["useRef"])();
  ...
  var handleCanvas = function handleCanvas(payload) {
    ...
    pdf.current = oIframwWindow.jspdf.jsPDF;
  };

  Object(react__WEBPACK_IMPORTED_MODULE_1__["useImperativeHandle"])(ref, function () {
    return {
      getCanvas: function (_getCanvas) {
        function getCanvas(_x) {
          return _getCanvas.apply(this, arguments);
        }

        getCanvas.toString = function () {
          return _getCanvas.toString();
        };

        return getCanvas;
      }(function (onCanvas) {
        return getCanvas(onCanvas);
      }),
...
_s(HTMLToPDF, "gQcpKkZrg4tKSAE8y3o2smAALrg=", false, function () {
...
//# sourceMappingURL=main.06597b60b297b7d1e041.hot-update.js.map