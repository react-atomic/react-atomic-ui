...
var Change = function Change(props) {
  ...
  var refPropsChildren = Object(react__WEBPACK_IMPORTED_MODULE_3__["useRef"])(false);

  var handleExited = function handleExited(node) {
    if (mount.current) {
      setChildren(function (prevChildren) {
        if (!prevChildren) {
          return refPropsChildren.current;
        } else {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_3__["useEffect"])(function () {
    mount.current = true;
    refPropsChildren.current = propsChildren;
    console.log({
      mount: mount,
      children: children,
...
_s(Change, "7QSciUlpDIWw/D5TQs8YeqHamv0=");
...
//# sourceMappingURL=main.1d889fffc202bdeb9a06.hot-update.js.map