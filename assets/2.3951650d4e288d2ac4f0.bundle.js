...
var ajaxGet = function ajaxGet(_ref) {
    ...
    __webpack_require__.e/* import() */(18/* duplicate */).then(__webpack_require__.bind(null, 615)).then(function (req) {
...
var ajaxPost = function ajaxPost(_ref2) {
    ...
    __webpack_require__.e/* import() */(18/* duplicate */).then(__webpack_require__.bind(null, 615)).then(function (req) {
        ...
        callReq.set(headers).end(function (err, res) {
            if (res) {
                var error = res.error,
                    _req2 = res.req,
                    text = res.text,
...
module.exports = __webpack_require__(650).polyfill();
...
//# sourceMappingURL=2.3951650d4e288d2ac4f0.bundle.js.map