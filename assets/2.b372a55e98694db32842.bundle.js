...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_transition_group_Transition__ = __webpack_require__(1065);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_class_lib__ = __webpack_require__(18);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_get_object_value__ = __webpack_require__(3);
...
var getValue = function getValue(arr, isAppear, isExit, defaultValue) {
    ...
    return Object(__WEBPACK_IMPORTED_MODULE_3_get_object_value__["default"])(arr, [index], defaultValue);
};
...
var handleFinish = function handleFinish(classList, handler, isExit, node, isAppear) {
    if (node) {
        ...
        if (thisClass) {
            setTimeout(function () {
                return node.className = Object(__WEBPACK_IMPORTED_MODULE_2_class_lib__["removeClass"])(node.className, thisClass);
            });
        }
    }
    if ('function' === typeof handler) {
...
var CSSTransition = function CSSTransition(_ref) {
    var classNames = _ref.classNames,
        ...
        props = _objectWithoutProperties(_ref, ['classNames', 'delay', 'isCompiled', 'isCSSTransition', 'onEnter', 'onEntering', 'onEntered', 'onExit', 'onExiting', 'onExited']);

    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_transition_group_Transition___default.a, _extends({}, props, {
...
var _PropTypes = __webpack_require__(1066);
...
//# sourceMappingURL=2.b372a55e98694db32842.bundle.js.map