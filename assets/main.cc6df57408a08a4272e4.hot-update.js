...
var Change = function Change(props) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_3__["useEffect"])(function () {
    ...
    if (nextChildren.current !== propsChildren && children !== propsChildren) {
      if (propsChildren && !isRunning.current) {
        nextChildren.current = propsChildren;
        setChildren(function (prevChildren) {
          if (prevChildren && prevChildren.key !== propsChildren.key) {
...
//# sourceMappingURL=main.cc6df57408a08a4272e4.hot-update.js.map