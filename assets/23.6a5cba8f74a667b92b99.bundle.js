...
var _getObjectValue = __webpack_require__(83);
...
var ajaxGet = function ajaxGet(_ref) {
    ...
    __webpack_require__.e/* require */(26).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(947)]; (function (req) {
...
var ajaxPost = function ajaxPost(_ref2) {
    ...
    var params = (0, _getObjectValue2.default)(action, ['params'], {});
    __webpack_require__.e/* require */(26/* duplicate */).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(947)]; (function (req) {
