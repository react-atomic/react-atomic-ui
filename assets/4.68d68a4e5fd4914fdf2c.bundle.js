...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_non_worker__ = __webpack_require__(1345);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_superagent__ = __webpack_require__(1346);
...
var handleMessage = function handleMessage(e) {
  var data = Object(__WEBPACK_IMPORTED_MODULE_5_get_object_value__["default"])(e, ['data']);
...
var ajaxGet = function ajaxGet(_ref) {
  var url = _ref.url,
      action = _ref.action;
  var params = Object(__WEBPACK_IMPORTED_MODULE_5_get_object_value__["default"])(action, ['params'], {});

  var headers = _objectSpread({}, Object(__WEBPACK_IMPORTED_MODULE_5_get_object_value__["default"])(params, ['globalHeaders'], {}), {}, Object(__WEBPACK_IMPORTED_MODULE_5_get_object_value__["default"])(params, ['headers'], {}), {
    Accept: Object(__WEBPACK_IMPORTED_MODULE_5_get_object_value__["default"])(params, ['accept'], 'application/json')
  });
...
var ajaxPost = function ajaxPost(_ref2) {
  ...
  var _get = Object(__WEBPACK_IMPORTED_MODULE_5_get_object_value__["default"])(action, ['params'], {}),
      query = _get.query,
      method = _get.method,
  ...
  Object(__WEBPACK_IMPORTED_MODULE_1_reshow_runtime_es_helpers_createClass__["a" /* default */])(WebSocketHelper, [{
    ...
    value: function open() {
      ...
      ws.onopen = function (e) {
        ...
        if (Object(__WEBPACK_IMPORTED_MODULE_5_get_object_value__["default"])(messages, ['length'])) {
...
//# sourceMappingURL=4.68d68a4e5fd4914fdf2c.bundle.js.map