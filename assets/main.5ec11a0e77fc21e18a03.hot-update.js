...
var Change = function Change(props) {
  ...
  var handleExited = function handleExited(node) {
    if (mount.current && nextChildren.current) {
      ...
      console.log('eeeexit', nextChildren.current);
    ...
    if (nextChildren.current !== propsChildren) {
      if (propsChildren) {
        ...
        setChildren(function (prevChildren) {
          if (prevChildren || isRunning.current) {
...
_s(Change, "+FcWOFUML64sMbNO2KrDAxUi8XU=");
...
//# sourceMappingURL=main.5ec11a0e77fc21e18a03.hot-update.js.map