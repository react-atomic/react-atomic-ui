...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__getTypeOf__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_reshow_constant__ = __webpack_require__(1);



var _typeof = function _typeof(o) {
  return __WEBPACK_IMPORTED_MODULE_1_reshow_constant__["d" /* SYMBOL */] === Object(__WEBPACK_IMPORTED_MODULE_0__getTypeOf__["a" /* default */])(o) ? __WEBPACK_IMPORTED_MODULE_1_reshow_constant__["d" /* SYMBOL */] : Object(__WEBPACK_IMPORTED_MODULE_0__getTypeOf__["a" /* default */])(o, __WEBPACK_IMPORTED_MODULE_1_reshow_constant__["c" /* OBJECT */]);
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_reshow_runtime_es_helpers_defineProperty__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_reshow_runtime_es_helpers_typeof__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_reshow_runtime_es_helpers_objectWithoutProperties__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_reshow_runtime_es_helpers_objectSpread__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_es6_promise_auto__ = __webpack_require__(10);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_get_object_value__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_non_worker__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_superagent__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_superagent___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9_superagent__);
 ...
 // Need keep if worker use "new Promise"
...
var handleMessage = function handleMessage(e) {
  var data = Object(__WEBPACK_IMPORTED_MODULE_7_get_object_value__["a" /* default */])(e, ['data']);
...
var oNonWorker = new __WEBPACK_IMPORTED_MODULE_8_non_worker__["a" /* default */]().onMessage(handleMessage);
...
var ajaxGet = function ajaxGet(_ref) {
  var url = _ref.url,
      action = _ref.action;
  var params = Object(__WEBPACK_IMPORTED_MODULE_7_get_object_value__["a" /* default */])(action, ['params'], {});

  var headers = Object(__WEBPACK_IMPORTED_MODULE_5_reshow_runtime_es_helpers_objectSpread__["a" /* default */])({}, Object(__WEBPACK_IMPORTED_MODULE_7_get_object_value__["a" /* default */])(params, ['globalHeaders'], {}), Object(__WEBPACK_IMPORTED_MODULE_7_get_object_value__["a" /* default */])(params, ['headers'], {}), {
    Accept: Object(__WEBPACK_IMPORTED_MODULE_7_get_object_value__["a" /* default */])(params, ['accept'], 'application/json')
  });

  __WEBPACK_IMPORTED_MODULE_9_superagent___default.a.get(url).query(params.query).set(headers).end(function (err, res) {
    if (res) {
      var error = res.error,
          _req = res.req,
          text = res.text,
      ...
      post(Object(__WEBPACK_IMPORTED_MODULE_5_reshow_runtime_es_helpers_objectSpread__["a" /* default */])({}, action, {
        text: text,
        response: response
      }));
    }
...
var ajaxPost = function ajaxPost(_ref2) {
  ...
  var _get = Object(__WEBPACK_IMPORTED_MODULE_7_get_object_value__["a" /* default */])(action, ['params'], {}),
      query = _get.query,
      method = _get.method,
  ...
  switch (method) {
    case 'delete':
      callReq = __WEBPACK_IMPORTED_MODULE_9_superagent___default.a.del(url);
      break;

    case 'head':
      callReq = __WEBPACK_IMPORTED_MODULE_9_superagent___default.a.head(url);
      break;

    case 'patch':
      callReq = __WEBPACK_IMPORTED_MODULE_9_superagent___default.a.patch(url);
      break;

    case 'put':
      callReq = __WEBPACK_IMPORTED_MODULE_9_superagent___default.a.put(url);
      break;

    default:
      callReq = __WEBPACK_IMPORTED_MODULE_9_superagent___default.a.post(url);
      break;
  }
  ...
  Object(__WEBPACK_IMPORTED_MODULE_1_reshow_runtime_es_helpers_createClass__["a" /* default */])(WebSocketHelper, [{
    ...
    value: function open() {
      ...
      ws.onopen = function (e) {
        ...
        if (Object(__WEBPACK_IMPORTED_MODULE_7_get_object_value__["a" /* default */])(messages, ['length'])) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__defineProperty__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__getTypeOf__ = __webpack_require__(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_reshow_runtime_es_helpers_typeof__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_reshow_constant__ = __webpack_require__(1);
...
var get = function get(o, path, defaultValue) {
  if (null === o || __WEBPACK_IMPORTED_MODULE_1_reshow_constant__["e" /* UNDEFINED */] === Object(__WEBPACK_IMPORTED_MODULE_0_reshow_runtime_es_helpers_typeof__["a" /* default */])(o)) {
  ...
  path.every(function (a) {
    if (null !== current[a] && __WEBPACK_IMPORTED_MODULE_1_reshow_constant__["e" /* UNDEFINED */] !== Object(__WEBPACK_IMPORTED_MODULE_0_reshow_runtime_es_helpers_typeof__["a" /* default */])(current[a])) {
      current = current[a];
      return true;
    } else {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_reshow_runtime_es_helpers_classCallCheck__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_reshow_runtime_es_helpers_defineProperty__ = __webpack_require__(0);
...
/***/ })
/******/ ]);
//# sourceMappingURL=cc70c3f8704f0b814d44.worker.js.map