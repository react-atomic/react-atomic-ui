...
var Change = function Change(props) {
  ...
  var refPropsChildren = Object(react__WEBPACK_IMPORTED_MODULE_3__["useRef"])(propsChildren);

  var handleExited = function handleExited(node) {
    if (mount.current) {
      setChildren(function (prevChildren) {
        console.log(refPropsChildren.current, 'pppp');
...
//# sourceMappingURL=main.d1db4e41545de9221b2e.hot-update.js.map